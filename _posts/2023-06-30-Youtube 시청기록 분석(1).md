---
layout: single
title: "Youtube 시청기록 분석(1)"
categories: Project
tag: [python, Pandas, Json, Youtube]
...
본 프로젝트에서는 추후 데이터 분석을 위해 Google Takeout을 통해 제공되는 유튜브 시청 기록 데이터를 수집하고, 데이터 전처리하는 것을 목표로 합니다.
...
시청기록의 동영상 제목을 기반으로 유튜브 API 활용해서 videoId를 가져오고, videoId를 통해서 categoryId와 tags를 가져옵니다
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>ZC1l9Xba4vk</td>
      <td>28</td>
      <td>['태블로', 'Tableau', '태블로 기초', 'Tableau Basics',...</td>
    </tr>
    <tr>
      <th>8</th>
      <td>태블로(Tableau) Full 기초 교육 영상 Part.1 태...</td>
      ...
      <td>qT38CVgKIfw</td>
      <td>27</td>
      <td>['태블로', '태블로교육', '태블로기초', '태블로상담', '태블로전문가', '...</td>
    </tr>
    <tr>
      <th>9</th>
      <td>(이코테 2021 강의 몰아보기) 1. 코딩 테스트 출제 경향 분석 및 파이썬 문법...</td>
      ...
      <td>m-9pAwq1o3w</td>
      <td>28</td>
      <td>['코딩 테스트', '코테', '파이썬 코딩 테스트', '알고리즘', '파이썬 알고...</td>
    </tr>
  </tbody>
</table>
</div>
...
![output_39_0]({{site.url}}\images\2023-06-30-Youtube 시청기록 분석(1)\output_39_0-1688087919470-1.png)
